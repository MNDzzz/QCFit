        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="space-y-6">
                ...
                <div class="bg-violet-50 dark:bg-violet-900/20 rounded-2xl p-6 border border-violet-100 dark:border-violet-900/50">
                    <h3 class="font-bold text-violet-900 dark:text-violet-400 text-sm mb-2 uppercase tracking-wider">Your Identity</h3>
                    <p class="text-sm text-violet-700 dark:text-violet-300 leading-relaxed">
                        Your alias and bio are public. Other users will see this information when they visit your profile.
                    </p>
                </div>
            </div>
